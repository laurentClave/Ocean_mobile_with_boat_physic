    ...
    SubShader {
        ...
        Pass {
            ...
            half4 frag (v2f i) : COLOR {
                ...
                half3 tangentNormal0 = ( tex2D(_Bump, buv.xy) + tex2D(_FoamBump, i.bumpTexCoord.xy) ) - 1;
                half3 tangentNormal1 = ( tex2D(_Bump, buv.zw) + tex2D(_FoamBump, i.bumpTexCoord.xy) ) - 1;
                ...
                half foam = clamp(tex2D(_Foam, i.bumpTexCoord.xy * 1.0)  - 0.5, 0.0, 1.0) * foamStrength;// * UNITY_LIGHTMODEL_AMBIENT.b;
